...
class TorchTrainer:
    ...
    def train(
        ...
        Returns:
            loss and accuracy
        """
        wandb.init(project='opt', entity='ipari3')
        ...
        for epoch in range(n_epoch):
            ...
            wandb.log({
                ...
                "test_f1": test_f1
            }) #각 epoch의 acc, f1과 best acc, f1 저장 (모델 비교용)
