...
from src.dataloader_oof import create_dataloader
from src.loss import CustomCriterion
from src.model import Model
from src.trainer_oof import TorchTrainer
...
def train(
    ...
    #============================================================================
    #Pretrained weight
    checkpoint = torch.load('./exp/2021-06-01_15-37-36/best.pt')
    ...
    #optimizer = Adam(model_instance.model.parameters(), lr=data_config["INIT_LR"], betas=(0.9, 0.999), weight_decay=1e-2)
    optimizer = torch.optim.AdamW(model_instance.model.parameters(), lr=data_config["INIT_LR"], betas=(0.9, 0.999), weight_decay=0.005)
